...
Процедура ОсновнаяРабота()
	...
	Попытка
		...
		ОбщиеМетоды.ДополнитьСоответствиеСУчетомПриоритета(ОбогащенныеЗначенияПараметров, Аргументы.ЗначенияПараметров);

		Аргументы.ЗначенияПараметров = ОбогащенныеЗначенияПараметров;
